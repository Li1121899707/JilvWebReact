...
import { Button, Col, Divider, Input, Row, Form, Radio, message, notification } from 'antd'
    ...
    return (
      <div className={styles.contentbox}>
        <div className={styles.header}>
          <span className={styles.tit}>菜单{this.pageType === 'edit' ? '编辑' : '新增'}</span>
        </div>
