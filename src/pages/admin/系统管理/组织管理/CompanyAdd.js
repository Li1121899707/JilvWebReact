        ...
        <div className={styles.middle}>
          ...
          <Form {...formItemLayout}>
            ...
            <Row>
              ...
              <Col span={10}>
                <Form.Item label='包含机构'>
                  {getFieldDecorator('sysOfficeIds', {
                    rules: [
                      {
                        required: true,
                        message: '必填!'
          ...
          <Divider />
          <Button type='primary' style={{ marginLeft: 130 }} onClick={this.submit}>
            保存
          </Button>
...
export default connect()(Form.create()(CompanyAdd))
