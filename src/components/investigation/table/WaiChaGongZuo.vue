  ...
  methods: {
    ...
    submit = () => {
      ...
      const obj = {
        ...
        time,
        leaderType: '登记人',
        link: `/admin/investigation/waichagongzuo/${this.id}/${countWaiChaArr.length}`
      }
      yijianArr.push(obj)
      waiChaArr.push(obj)
      WaiChaArrObj.shenChaDiaoCha_waiChaYiJian = waiChaArr
      //WaiChaArrObj.shenChaDiaoCha_waiChaGongZuo_files = this.fileRef.fileList
      ...
      //values.shenChaDiaoCha_waiChaGongZuo_files = this.fileRef.fileList
