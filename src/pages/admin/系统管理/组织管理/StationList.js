...
import { Form, Button, Divider, Icon, Input, Layout, Select, Table, Tag, Tooltip, Modal, notification } from 'antd'
          ...
          const bj_bt = (
            <Tooltip placement='top' title='编辑岗位'>
              <Button
                ...
                style={{ paddingLeft: 0 }}
                onClick={() => {
                  router.push({ pathname: `/admin/system/organ/stationedit/${record.id}` })
                }}
              >
          ...
          <Content className={styles.contentbox}>
            <div className={styles.header}>
              ...
              <Button
                ...
                onClick={() => {
                  router.push('/admin/system/organ/stationadd') // 跳转方式 2
                }}
              >
                <Icon type='plus' />
                新增
