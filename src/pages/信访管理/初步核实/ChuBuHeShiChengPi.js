...
class ChuBuHeShiChengPi extends Component {
  constructor(props) {
    super(props)
    this.state = {
      dataSource: {},
    ...
    if (taskName !== '填写初步核实申请呈批表') {
      ...
      this.props.form.validateFields((err, values) => {
        ...
        const obj = {
          ...
          leaderType: '登记人',
          link: taskDefinitionKey === 'chuBuHeShi_chengpi' ? `/admin/petition/check/show/${processInstanceId}/ShenPiChuBuHeShiChengPi` : ''
        }
        yijianArr.push(obj)
        values.chuBuHeShi_chuBuHeShiChengPi = yijianArr
        values.chuBuHeShi_chuBuHeShiChengPi_files = this.fileRef.state.fileList
        ...
        <div className={styles.content_box}>
          ...
          <DisplayControlComponent>
            <div style={{ textAlign: 'left' }}>
              <UploadComp
                ...
                fileList={dataSource.chuBuHeShi_files || []}
                ref={ref => {
                  this.fileRef = ref
                }}
              />
          ...
          {this.type === 'show' && (
            <p style={{ textAlign: 'left' }}>
              相关附件:
              {dataSource.chuBuHeShi_files &&
                dataSource.chuBuHeShi_files.map(item => (
                  <a
                    target='_blank'
                    onClick={() => {
...
const wapper = Form.create()(ChuBuHeShiChengPi)
