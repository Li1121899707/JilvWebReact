...
import { Button, Form, Input, notification, Select, Tabs, Timeline, Upload, DatePicker } from 'antd'
...
class AnJianYiSongTable extends Component {
  constructor(props) {
    super(props)
    this.state = {
      dataSource: {},
  ...
  submit = () => {
    ...
    if (taskName !== '填写案件移送审理审批表') {
      ...
      this.props.form.validateFields((err, values) => {
        ...
        values.shenChaDiaoCha_anJianYiSong_files = this.fileRef.state.fileList
        post(
            ...
            <table className={styles.table}>
              <tbody>
                ...
                <tr>
                  ...
                  <td className={styles.val} colSpan={3}>
                    <TableInput propsMode='add' data={dataSource.shenChaDiaoCha_yiSongShenLi_liAnJiGuan}>
                      <Form.Item>
                        {getFieldDecorator('shenChaDiaoCha_yiSongShenLi_liAnJiGuan', {
                  ...
                  <td className={styles.val} colSpan={3}>
                    ...
                    >
                      <Form.Item>
                        {getFieldDecorator('shenChaDiaoCha_yiSongShenLi_liAnShiJian', {
                          rules: [{ required: true, message: '必填!' }]
                        })(<DatePicker size='large' allowClear style={{ width: '100%' }} />)}
                      </Form.Item>
                    </TableInput>
                  </td>
                </tr>
            ...
            <DisplayControlComponent>
              <div style={{ textAlign: 'left' }}>
                <UploadComp
                  ...
                  fileList={dataSource.shenChaDiaoCha_anJianYiSong_files || []}
                  ref={ref => {
                    this.fileRef = ref
                  }}
                />
...
const wapper = Form.create()(AnJianYiSongTable)
