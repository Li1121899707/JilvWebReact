...
class TiQianJieRuShenPiTable extends Component {
  constructor(props) {
    super(props)
    this.state = {
      dataSource: {},
    ...
    this.statusKey = 'LiAnShenCha_tiQianJieRu'
  }
  ...
  submit = () => {
    ...
    this.props.form.validateFields((err, values) => {
      ...
      if (taskGroup === 'LiAnShenCha_tiQianJieRu_dangWeiShuJi') {
        values.shenChaDiaoCha_status = '提前介入审理已审批'
      } else {
        values.shenChaDiaoCha_status = '提前介入审理审批中'
      }
      ...
      if (err) return false
      let yijianArr = []
      if (this.state.dataSource.shenChaDiaoCha_tiQianJieRu) {
        yijianArr = this.state.dataSource.shenChaDiaoCha_tiQianJieRu
      }
...
const wapper = Form.create()(TiQianJieRuShenPiTable)
