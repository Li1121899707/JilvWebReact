...
import {get} from '@/utils/http'
    ...
    export default {
        ...
        methods: {
            search(){
                var url = 'activiti/process/instances/all?processDefinitionKey=' + GLOBAL.processDefinitionKey + '&search=,status=审理管理,isShenLiGuanLi_yueDuJinDu=true'
                get(url, {
                    size: 5,
