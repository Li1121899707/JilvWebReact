...
class LiaoJieTable extends Component {
  constructor(props) {
    super(props)
    this.state = {
      dataSource: {},
  ...
  submit = () => {
    ...
    this.props.form.validateFields((err, values) => {
      ...
      const obj = {
        ...
        type: '了结理由及情况说明',
        advise: values.wenTiXianSuo_liaoJieLiYou ? values.wenTiXianSuo_liaoJieLiYou : '',
        time
      }
      yijianArr.push(obj)
      ...
      if (chuZhiFangShi === '予以了结') {
        values.wenTiXianSuo_status = '予以了结已登记'
      }
      if (err) return false
      console.log(values)
        ...
        <div className={style.content_box}>
          ...
          <Form>
            ...
            <p className={style.title} style={{ textAlign: 'left' }}>
              上传附件: <Upload>《谈话函询情况报告》</Upload>
            </p>
            <div className={styles.title}>
              <TableInput data={dataSource.wenTiXianSuo_liaoJieLiYou}>
...
const wapper = Form.create()(LiaoJieTable)
