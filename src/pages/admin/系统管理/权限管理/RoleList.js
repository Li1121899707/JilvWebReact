          ...
          let tt = (
            <div>
              ...
              <Tooltip title='授权菜单'>
                <Tag
                  onClick={() => {
                    router.push(`/admin/system/limit/roleMenu/${record.id}`)
                  }}
                >
                  授权菜单
                </Tag>
          ...
          <Content className={styles.contentbox}>
            <div className={styles.header}>
              ...
              <Button
                ...
                onClick={() => {
                  router.push('/admin/system/limit/roleadd') // 跳转方式 2
                }}
              >
                <Icon type='plus' />
                新增
            ...
            <div className={styles.rightDiv}>
              <Form layout='inline' style={{ display: this.state.isShow }}>
                <Form.Item label='角色名称：'>{getFieldDecorator(`roleName`)(<Input allowClear />)}</Form.Item>
                <Form.Item label='角色编码：'>{getFieldDecorator(`roleCode`)(<Input allowClear />)}</Form.Item>
