...
class LiAnShenChaBaoGaoTable extends Component {
  constructor(props) {
    super(props)
    this.state = {
      dataSource: {},
  ...
  submit = () => {
    ...
    this.props.form.validateFields((err, values) => {
      ...
      const obj = {
        ...
        leaderType: '登记人',
        link: `/admin/petition/investigation/show/${this.id}/lianshenchabaogaoshenpi`
      }
      yijianArr.push(obj)
    ...
    return (
      <div className={styles.content}>
        <div className={styles.content_box_LiAn}>
          ...
          <p className={styles.title}>立案审查报告呈批表</p>
          <Form>
            <table className={styles.table}>
              <tbody>
                ...
                <tr>
                  <td className={styles.label}>审查情况</td>
                  <td className={styles.val} colSpan={7}>
                    <TableInput propsMode='add' data={dataSource.shenChaDiaoCha_shenChaBaoGao_qingKuang}>
                      <Form.Item>
                        {getFieldDecorator('shenChaDiaoCha_shenChaBaoGao_qingKuang', {
...
xxx（承办室）                  xx年x月x日'
            ...
            <DisplayControlComponent>
              <div style={{ textAlign: 'left' }}>
                <UploadComp
                  ...
                  fileList={dataSource.shenChaDiaoCha_baoGaoChengPi_files || []}
                  ref={ref => {
                    this.fileRef = ref
                  }}
                />
            ...
            <div>
              <TableInput data={dataSource.liAnShenLi_houXuChuZhiFangShi}>
                <Form.Item style={{ display: 'flex' }} label='后续处置方式'>
                  {getFieldDecorator('liAnShenLi_houXuChuZhiFangShi', {
                    rules: [{ required: true, message: '必填!' }]
                  })(
...
const wapper = Form.create()(LiAnShenChaBaoGaoTable)
