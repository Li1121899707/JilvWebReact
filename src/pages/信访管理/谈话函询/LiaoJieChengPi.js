...
class LiaoJieChengPi extends Component {
  ...
  submit = () => {
    ...
    this.props.form.validateFields((err, values) => {
      ...
      if (err) return false
      values.tanHuaHanXun_status = '了结呈批已登记'
      post(
  ...
  huoquhouxunaren = () => {
    ...
    let taskId = 'tanHuaHanXun_liaoJieChengQing_jiJianJianChaShi'
      ...
      <div className={style.content}>
        <div className={style.content_box}>
          ...
          <Form>
                                    ...
                                    {item.map((items, i) => {
                                      return (
                                        <Timeline.Item key={i} style={{ textAlign: 'left' }}>
                                          ...
                                          <div className={style.bold}>{items.type}：</div>
            ...
            <div>
              <TableInput data={dataSource.tanHuaHanXun_niBanYiJian}>
