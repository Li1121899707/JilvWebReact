    ...
    return (
      <div className={styles.contentbox}>
        <div className={styles.header}>
          <span className={styles.tit}>{this.state.title}新增用户</span>
        </div>
            ...
            <Row>
              <Col span={20} offset={1}>
                <Form.Item label='备注信息' wrapperCol={{ span: 19 }} labelCol={{ span: 3 }}>
                  {getFieldDecorator('remarks', { rules: [{ required: true, message: '必填!' }], initialValue: data.remarks })(<TextArea rows={4} />)}
                </Form.Item>
              </Col>
            </Row>
          </Form>
