            ...
            return (
              <div>
                <Button
                  ...
                  size='small'
                  onClick={() => {
                    router.push('/admin/petition/check/add/1/ChuHeBaoGaoChengPi')
                  }}
                >
                  填写初步核实报告呈批表
                </Button>
            ...
            return (
              <div>
                ...
                <Button
                  ...
                  size='small'
                  onClick={() => {
                    router.push('/admin/petition/check/add/1/ShenPiChuHeBaoGaoChengPi')
                  }}
                >
                  审批
                </Button>
                    ...
                    <tr>
                      <td>
                        <Form.Item label='初步核实日期起'>
                          {getFieldDecorator('chuBuHeShi_baoGao_heShiRiQi>', {
                      ...
                      <td>
                        <Form.Item label='办理状态'>
                          {getFieldDecorator('chuBuHeShi_baoGao_banLiZhuangTai=', {
                            // getValueFromEvent: event => event.target.value.replace(/\s+/g, ''),
                    ...
                    <tr>
                      <td>
                        <Form.Item label='线索来源'>
                          {getFieldDecorator('chuBuHeShi_baoGao_xianSuoLaiYuan=', {
                            // getValueFromEvent: event => event.target.value.replace(/\s+/g, ''),
                            initialValue: defaultValue ? defaultValue.customerinfoGroup : ''
                          })(
                            <Select allowClear>
                      ...
                      <td>
                        <Form.Item label='被反映人'>
                          {getFieldDecorator('chuBuHeShi_baoGao_beiFanYingRen~', {
                            getValueFromEvent: event => event.target.value.replace(/\s+/g, ''),
                            initialValue: defaultValue ? defaultValue.customerinfoGroup : ''
                      ...
                      <td>
                        <Form.Item label='反映人'>
                          {getFieldDecorator('chuBuHeShi_baoGao_fanYingRen~', {
