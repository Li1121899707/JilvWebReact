...
export const untils = async (taskGroup, type, processDefinitionKey = ProcessDefinitionKey) => {
  let taskId
  const houXuanRenGroup = [
    ...
    { now: 'zongHeBanGongGuanLi', next: 'faWenBuMenLingDao' },
    { now: 'faWenBuMenLingDao', next: 'faWenLingDao' },
    { now: 'shouWenBuMenLingDao', next: 'shouWenLingDao' }
  ]
