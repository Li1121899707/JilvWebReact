...
<div>
    ...
    <Table height="500" :columns="clueScheduleListColumnsWithCheck" :data="dataSource"></Table>
...
import {get} from '@/utils/http'
    ...
    export default {
        ...
        data () {
            return {
                clueScheduleListColumnsWithCheck: [
                    {
                        type: 'selection',
                        width: 60,
                        align: 'center'
                                    ...
                                    h('span', {
                                        ...
                                        on: {
                                            click: () => {
                                                ...
                                                this.$router.push({ path: 'show-clue-schedule-detail' })
                                            }
                                        }
                                    },'查看'),
                                ])
        ...
        methods: {
            search(){
                var url = 'activiti/process/instances/all?processDefinitionKey=' + GLOBAL.processDefinitionKey + '&search=,status=问题线索,isWenTiXianSuo_yueDuJinDu=true'
                get(url, {
                    size: 10,
