...
<div>
    ...
    <Table height="600" :columns="investigationLiAnZhunBeiListColumns" :data="dataSource"></Table>
...
import {get} from '@/utils/http'
    ...
    export default {
        data () {
            return {
                investigationLiAnZhunBeiListColumns: GLOBAL.investigationLiAnZhunBeiListColumns,
                dataSource: [],
                // 线索反映问题类型 select 框
        ...
        methods: {
            search(){
                var url = 'activiti/process/instances/all?processDefinitionKey=' + GLOBAL.processDefinitionKey + '&search=,status=审查调查，shenChaDiaoCha_childstatus=立案准备'
                get(url, {
                    size: 10,
