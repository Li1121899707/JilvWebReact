          ...
          <table>
            <tbody>
                ...
                <tr>
                  <td>案件名称</td>
                  <td colspan="7">
                    <div> {{tanHuaHanXun_anJianMingCheng}} </div>
                  </td>
                </tr>
                <tr>
                  <td>拟办/审批意见</td>
        ...
        methods: {
            load(){
                ...
                get(url, {
                    ...
                    wenTiXianSuo_xianSuoLaiYuan = res.data.form.wenTiXianSuo_xianSuoLaiYuan
                    wenTiXianSuo_xuHao = res.data.form.wenTiXianSuo_xuHao
                    wenTiXianSuo_shouDaoShiJian = res.data.form.wenTiXianSuo_shouDaoShiJian
                    wenTiXianSuo_fanYingRen = res.data.form.wenTiXianSuo_fanYingRen
                    wenTiXianSuo_xingBie = res.data.form.wenTiXianSuo_xingBie
                    wenTiXianSuo_zhengZhiMianMao = res.data.form.wenTiXianSuo_zhengZhiMianMao
                    wenTiXianSuo_dianHua = res.data.form.wenTiXianSuo_dianHua
                    wenTiXianSuo_diZhi = res.data.form.wenTiXianSuo_diZhi
                    wenTiXianSuo_fanYingRenDanWei = res.data.form.wenTiXianSuo_fanYingRenDanWei
                    wenTiXianSuo_fanYingRenZhiWu = res.data.form.wenTiXianSuo_fanYingRenZhiWu
                    wenTiXianSuo_beiFanYingRen = res.data.form.wenTiXianSuo_beiFanYingRen
                    wenTiXianSuo_beiFanYingRenDanWei = res.data.form.wenTiXianSuo_beiFanYingRenDanWei
                    wenTiXianSuo_beiFanYingRenZhiWu = res.data.form.wenTiXianSuo_beiFanYingRenZhiWu
                    wenTiXianSuo_fanYingZhuYaoWenTi = res.data.form.wenTiXianSuo_fanYingZhuYaoWenTi
                })
