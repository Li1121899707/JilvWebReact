    ...
    return (
      <div>
                    ...
                    <tr>
                      <td>
                        <Form.Item label='建档时间起'>
                          {getFieldDecorator('chuBuHeShi_anJuan_jianDangShiJian>', {
                      ...
                      <td>
                        <Form.Item label='处理结论'>
                          {getFieldDecorator('chuBuHeShi_anJuan_chuLiJieLun=', {
                            // getValueFromEvent: event => event.target.value.replace(/\s+/g, ''),
                    ...
                    <tr>
                      <td>
                        <Form.Item label='被反映人'>
                          {getFieldDecorator('chuBuHeShi_anJuan_beiFanYingRen~', {
                            getValueFromEvent: event => event.target.value.replace(/\s+/g, ''),
                            initialValue: defaultValue ? defaultValue.customerinfoGroup : ''
                      ...
                      <td>
                        <Form.Item label='反映人'>
                          {getFieldDecorator('chuBuHeShi_anJuan_fanYingRen~', {
                      ...
                      <td>
                        <Form.Item label='线索编号'>
                          {getFieldDecorator('chuBuHeShi_anJuan_xianSuoBianHao~', {
                            initialValue: defaultValue ? defaultValue.customerinfoIfgroup : ''
                          })(<Input allowClear />)}
                        </Form.Item>
                      </td>
                    ...
                    <tr>
                      <td>
                        <Form.Item label='案卷编号'>
                          {getFieldDecorator('chuBuHeShi_anJuan_anJuanBianHao~', {
                            initialValue: defaultValue ? defaultValue.customerinfoIfgroup : ''
                          })(<Input allowClear />)}
                        </Form.Item>
                      </td>
        ...
        <Modal
          ...
          okText='创建'
          onOk={() => {
            router.push('/admin/petition/check/detail')
          }}
          onCancel={() => {
