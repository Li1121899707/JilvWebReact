...
class LiAnShenChaBaoGaoShenPiTable extends Component {
  constructor(props) {
    super(props)
    this.state = {
      dataSource: {},
    ...
    this.statusKey = 'LiAnShenCha_baoGao'
  }
  ...
  submit = () => {
    ...
    this.props.form.validateFields((err, values) => {
      ...
      if (err) return false
      let yijianArr = []
      if (this.state.dataSource.shenChaDiaoCha_baoGaoChengPi) {
        yijianArr = this.state.dataSource.shenChaDiaoCha_baoGaoChengPi
      }
        ...
        <div className={styles.content_box_LiAn}>
          ...
          <Form>
            <table className={styles.table}>
              <tbody>
                ...
                <tr>
                  ...
                  <td className={styles.val} colSpan={7}>
                    <TableInput propsMode='show' data={dataSource.shenChaDiaoCha_shenChaBaoGao_qingKuang} />
                  </td>
                </tr>
                <tr>
            ...
            <p style={{ textAlign: 'left' }}>
              相关附件:
              {dataSource.shenChaDiaoCha_baoGaoChengPi_files &&
                dataSource.shenChaDiaoCha_baoGaoChengPi_files.map(item => (
                  <a
                    target='_blank'
                    onClick={() => {
...
const wapper = Form.create()(LiAnShenChaBaoGaoShenPiTable)
