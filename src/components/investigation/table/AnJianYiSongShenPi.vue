      ...
      <table>
        <tbody>
          ...
          <tr>
            <td>立案机关</td>
            <td colspan="3">
              {{showData.shenChaDiaoCha_yiSongShenLi_liAnJiGuan}}
            </td>
            <td>立案时间</td>
            <td colspan="3">
              {{showData.shenChaDiaoCha_yiSongShenLi_liAnShiJian}}
            </td>
          </tr>
...
export default {
  ...
  data () {
    return {
      id:'',
      statusKey: 'LiAnShenCha_anJianYiSong',
      dataSource: {},
      leaderList: [],
      leader: '',
      data: {},
  ...
  methods: {
    ...
    submit(){
      ...
      let yijianArr = []
      if (this.dataSource.shenChaDiaoCha_anJianYiSong) {
        yijianArr = this.dataSource.shenChaDiaoCha_anJianYiSong
      }
